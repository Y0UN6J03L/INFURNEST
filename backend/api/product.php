...
<nav class="navbar-custom" id="mainNav">
  <div class="container">
      ...
      <div class="d-flex align-items-center gap-2">
        ...
        <div class="dropdown d-none d-sm-flex">
          ...
          <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profileDropdown">
            ...
            <?php else: ?>
              <li><a class="dropdown-item" href="<?= $base ?>pages/login.php"><i class="fas fa-sign-in-alt"></i> Login</a></li>
              <li><a class="dropdown-item" href="<?= $base ?>pages/register.php"><i class="fas fa-user-plus"></i> Register</a></li>
            <?php endif; ?>
          </ul>
        </div>

        <a class="profile-btn-mobile d-flex d-sm-none"
           href="<?= $isLoggedIn ? $base.'pages/dashboard.php' : $base.'pages/login.php' ?>">
          <i class="fas fa-user-circle"></i>
        </a>
    ...
    <div class="mobile-menu" id="mobileMenu">
      ...
      <?php else: ?>
        <a id="mnav-login" href="<?= $base ?>pages/login.php">🔐 Login</a>
      <?php endif; ?>
    </div>
  </div>
</nav>
