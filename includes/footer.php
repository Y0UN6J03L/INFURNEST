  ...
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-6 col-md-2">
        <h5>Shop</h5>
        <a href="<?= $base ?>pages/shop.php?category=dog">Dog Products</a>
        <a href="<?= $base ?>pages/shop.php?category=cat">Cat Products</a>
        <a href="<?= $base ?>pages/shop.php?category=food">Pet Food</a>
        <a href="<?= $base ?>pages/shop.php?category=toys">Toys</a>
      </div>
      <div class="col-6 col-md-2">
        <h5>Help</h5>
        <a href="<?= $base ?>pages/contact.php">Contact Us</a>
        <a href="<?= $base ?>pages/faqs.php">FAQs</a>
