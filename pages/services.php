...
<div class="container py-5">
  ...
  <div class="row align-items-center g-5 mb-5">
    <div class="col-md-6">
      ...
      <h2 class="section-title" style="margin-bottom:20px;">Premium Services for Your <span>Furry Friends</span></h2>
      <p style="color:var(--text-mid);line-height:1.8;margin-bottom:16px;">At INFURNEST, we go beyond just selling products. We're committed to providing comprehensive services that ensure your pets receive the best care possible.</p>
    </div>
  ...
  <div class="row g-4 mb-5">
    <div class="col-md-6 col-lg-4">
      <div class="service-card" style="background:white;border-radius:var(--radius);padding:32px;box-shadow:var(--shadow);height:100%;">
        <div style="font-size:3rem;margin-bottom:16px;">🚚</div>
        <h5 style="font-family:'Playfair Display',serif;color:var(--brown);margin-bottom:12px;">Free Delivery</h5>
        <p style="color:var(--text-light);font-size:0.9rem;line-height:1.6;">Enjoy free delivery on orders over ₱999. Same-day metro delivery available for selected areas.</p>
      </div>
    </div>
    <div class="col-md-6 col-lg-4">
      <div class="service-card" style="background:white;border-radius:var(--radius);padding:32px;box-shadow:var(--shadow);height:100%;">
        <div style="font-size:3rem;margin-bottom:16px;">🩺</div>
        <h5 style="font-family:'Playfair Display',serif;color:var(--brown);margin-bottom:12px;">Vet Consultation</h5>
        <p style="color:var(--text-light);font-size:0.9rem;line-height:1.6;">Free vet consultation for product recommendations. Our experts ensure the best choices for your pet.</p>
      </div>
    </div>
    <div class="col-md-6 col-lg-4">
      <div class="service-card" style="background:white;border-radius:var(--radius);padding:32px;box-shadow:var(--shadow);height:100%;">
        <div style="font-size:3rem;margin-bottom:16px;">🔄</div>
        <h5 style="font-family:'Playfair Display',serif;color:var(--brown);margin-bottom:12px;">Easy Returns</h5>
        <p style="color:var(--text-light);font-size:0.9rem;line-height:1.6;">30-day hassle-free returns. No questions asked. We want you and your pet to be completely satisfied.</p>
      </div>
    </div>
    <div class="col-md-6 col-lg-4">
      <div class="service-card" style="background:white;border-radius:var(--radius);padding:32px;box-shadow:var(--shadow);height:100%;">
        <div style="font-size:3rem;margin-bottom:16px;">💬</div>
        <h5 style="font-family:'Playfair Display',serif;color:var(--brown);margin-bottom:12px;">24/7 Support</h5>
        <p style="color:var(--text-light);font-size:0.9rem;line-height:1.6;">Our pet care team is available round-the-clock to assist you with any questions or concerns.</p>
      </div>
    </div>
    <div class="col-md-6 col-lg-4">
      <div class="service-card" style="background:white;border-radius:var(--radius);padding:32px;box-shadow:var(--shadow);height:100%;">
        <div style="font-size:3rem;margin-bottom:16px;">📦</div>
        <h5 style="font-family:'Playfair Display',serif;color:var(--brown);margin-bottom:12px;">Grooming Supplies</h5>
        <p style="color:var(--text-light);font-size:0.9rem;line-height:1.6;">Professional-grade grooming tools and products to keep your pets looking their best.</p>
      </div>
    </div>
    <div class="col-md-6 col-lg-4">
      <div class="service-card" style="background:white;border-radius:var(--radius);padding:32px;box-shadow:var(--shadow);height:100%;">
        <div style="font-size:3rem;margin-bottom:16px;">🎓</div>
        <h5 style="font-family:'Playfair Display',serif;color:var(--brown);margin-bottom:12px;">Pet Training Tips</h5>
        <p style="color:var(--text-light);font-size:0.9rem;line-height:1.6;">Access free training guides and tips from professional pet behaviorists.</p>
      </div>
    </div>
  </div>
  ...
  <div class="text-center py-4">
    <h3 style="font-family:'Playfair Display',serif;color:var(--brown);margin-bottom:16px;">Ready to give your pet the best?</h3>
    <a class="btn-primary-custom" href="shop.php"><i class="fas fa-store"></i> Shop Now</a>
  </div>
